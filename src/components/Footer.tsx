        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/partners" className="text-gray-400 hover:text-white transition-colors">Brands</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">info@bbsoman.com</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="/src/pages/TermsAndConditionpages" className="text-gray-400 hover:text-white transition-colors">Terms of Service</a>
