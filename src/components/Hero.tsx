        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-20">
          ...
          <div className="flex-1 text-center lg:text-left lg:pr-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
              Bright Business Solutions specializes in cutting-edge artificial intelligence, augmented reality, 
              and virtual reality technologies. We partner with industry leaders to deliver innovative solutions 
              that drive your business forward.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href='/partners' className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center">
                Explore Solutions
                <ArrowRight className="w-5 h-5 ml-2" />
              </a>
              <a href="/partners" className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-all">
                Brands
              </a>
            </div>
          </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-6 max-w-md mx-auto">
                <div className="bg-white rounded-2xl p-6 shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  ...
                  <p className="text-sm text-gray-600">Intelligent automation and machine learning</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl transform -rotate-3 hover:rotate-0 transition-transform duration-300 mt-8">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">AR/VR Tech</h3>
                  <p className="text-sm text-gray-600">Immersive experiences and virtual environments</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl transform rotate-2 hover:rotate-0 transition-transform duration-300 -mt-4">
                  ...
                  <p className="text-sm text-gray-600">Cutting-edge technology implementations</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl transform -rotate-2 hover:rotate-0 transition-transform duration-300">
                  ...
                  <p className="text-sm text-gray-600">Scalable solutions for business expansion</p>
                </div>
              </div>
            </div>
          </div>
